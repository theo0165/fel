...
export default function HandSection() {
  return (
    <div className="grid h-[1000px] pt-[100px] grid-cols-50/50 overflow-hidden hand-order:grid-rows-2 hand-order:grid-cols-none hand-order:h-auto bg-main-red text-white">
      <div className="relative hand-order:flex flex-col hand-order:pt-[120px]">
        ...
        <p className="absolute -translate-y-1/2 top-[80%] left-0 text-[32px] text-left px-[40px] pb-[200px] hand-order:static hand-order:-translate-y-0 hand-order:pt-[120px]">
      ...
      <div className="relative hand-order:flex flex-col hand-order:py-[60px]">
        ...
        <p className="absolute -translate-y-1/2 top-[80%] right-8 text-[32px] text-right px-[40px] pb-[200px] hand-order:static hand-order:-translate-y-0 hand-order:pt-[120px]">
